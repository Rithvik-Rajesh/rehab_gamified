...
DUCKING = [pygame.image.load(os.path.join("rehab_gamification/assets/dino_game/Dino", "DinoDuck1.png")),
           pygame.image.load(os.path.join("rehab_gamification/assets/dino_game/Dino", "DinoDuck2.png"))]
